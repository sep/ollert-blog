---
layout: post
title: "Larry Price: Hotfixing a Bug in Trello's client.js"
date: 2014-12-03 14:56:33 -0500
comments: true
categories: larry-price tech
---

_Originally posted August 22, 2014, by [Larry Price](http://www.larry-price.com/blog/2014/08/22/fixing-some-minor-bugs-in-trellos-client-dot-js/)._

I'm a huge fan of [Trello](https://trello.com), and I recently created an app to analyze Trello data called [Ollert](https://ollertapp.com). Ollert makes heavy use of the [Trello API](http://trello.com/docs). I've written previously about [using Trello's client.js to connect to the Trello API](http://www.larry-price.com/blog/2014/03/18/connecting-to-the-trello-api/).
...
From [another issue I was having](http://www.larry-price.com/blog/2014/07/07/deauthorizing-token-with-the-trello-client/), I already call `Trello.deauthorize()` before my application attempts to contact Trello, so now I also make a call to `Trello.clearReady()`. My `authorize()` function looks like this:
